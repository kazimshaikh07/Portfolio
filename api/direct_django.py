# Direct Django WSGI handler for Vercel
import json
import os
import sys
import traceback
...
try:
    # Add the project root and portfolio directory to the Python path
    ...
    # Import Django WSGI application directly
    ...
    def handler(request, **kwargs):
        """A handler that uses the Django WSGI application directly."""
        try:
